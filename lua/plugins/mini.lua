return {
  ...
  -- File explorer (this works properly with oil unlike nvim-tree)
  {
    ...
    keys = {
      { '<leader>ee', '<cmd>lua MiniFiles.open()<CR>' },
      {
        "<leader>ef",
        function()
  ...
  -- Split & join
  {
    ...
    keys = {
      {"sj", function() require('mini.splitjoin').join() end, { "n", "x" }, desc = "Join arguments"},
      {"sk", function() require('mini.splitjoin').split() end, { "n", "x" }, desc = "Join arguments"},
    },
    opts = {
